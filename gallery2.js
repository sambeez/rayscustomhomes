function animationInit() {
    ...
    for (var i = 0; i < thumbnails2.length; i++) {
        thumbnails2[i].addEventListener('click', function () {
            ...
            document.querySelector('.gallery-feature2').src = this.src
        })
    }
    ...
    const btnLeft2 = document.querySelector('.thumbnails-button-left2');
    const btnRight2 = document.querySelector('.thumbnails-button-right2');
    const thumbGallery2 = document.querySelector('.gallery-thumbnails-slider2');
    thumbGallery2.scrollLeft = 0

    btnLeft2.addEventListener('click', function(){
        thumbGallery2.scrollLeft -= 90

        var activeElem = thumbGallery2.querySelectorAll('.active2');
        console.log(activeElem[0]);
        if (activeElem[0].previousElementSibling != null) {
            activeElem[0].classList.remove('active2');
            activeElem[0].previousElementSibling.classList.add('active2');
            document.querySelector('.gallery-feature2').src = activeElem[0].previousElementSibling.src
        }
    })
    ...
    btnRight2.addEventListener('click', function(){
        ...
        if (activeElem[0].nextElementSibling != null) {
            activeElem[0].classList.remove('active2');
            activeElem[0].nextElementSibling.classList.add('active2');
            document.querySelector('.gallery-feature2').src = activeElem[0].nextElementSibling.src
        }
    })
